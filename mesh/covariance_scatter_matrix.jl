"""
  ...
  #
"""
function covariance_scatter_matrix(V::Array{Float64}, F::Array{Int64}; 
                                   energy="spokes")

  # default energy is Sorkine and Alexa style local rigidity energy
  # number of vertices
  n = size(V,1);
  # number of elements
  m = size(F,1);
