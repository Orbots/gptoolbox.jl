...
"""
function cotangent(V,F; SideLengths = [], FaceAreas = [] )
  ...
  elseif ndim == 4
    ...
    (_,cos_theta) = dihedral_angles([],[],"SideLengths",l,"FaceAreas",s);
    ...
    sin_theta = broadcast(./, vol,(2./(3*l)) .* s(:,[2 3 1 4 4 4]) .* s(:,[3 1 2 1 2 3]));
